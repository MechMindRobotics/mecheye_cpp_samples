...
3. Run Cmake and set the source and build paths:
   ...
   | Field                       | Path                                      |
   | :----                       | :----                                     |
   | Where is the source code    | xxx/TriggerWithSoftwareAndFixedRate       |
   | Where to build the binaries | xxx/TriggerWithSoftwareAndFixedRate/build |
...
1. Navigate to the directory of the sample.
   ...
   ```bash
   cd xxx/profiler/TriggerWithSoftwareAndFixedRate/
   ```
...
3. Run the sample.
   ...
   ```bash
   sudo ./TriggerWithSoftwareAndFixedRate
   ```

4. Enter the index of the laser profiler to which you want to connect, and press the Enter key. The obtained files are saved to `/TriggerWithSoftwareAndFixedRate/build`.
