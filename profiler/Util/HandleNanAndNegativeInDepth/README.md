...
3. Run Cmake and set the source and build paths:
   ...
   | Field                       | Path                                  |
   | :-------------------------- | :------------------------------------ |
   | Where is the source code    | xxx/HandleNanAndNegativeInDepth       |
   | Where to build the binaries | xxx/HandleNanAndNegativeInDepth/build |
...
1. Navigate to the directory of the sample.
   ...
   ```bash
   cd xxx/profiler/HandleNanAndNegativeInDepth/
   ```
...
3. Run the sample.
   ...
   ```bash
   sudo ./HandleNanAndNegativeInDepth
   ```

4. Enter the index of the laser profiler to which you want to connect, and press the Enter key. The obtained files are saved to `/HandleNanAndNegativeInDepth/build`.
