...
2. Run Cmake and set the source and build paths:
   ...
   | Field                       | Path                            |
   | :----                       | :----                           |
   | Where is the source code    | xxx/SetScanningParameters       |
   | Where to build the binaries | xxx/SetScanningParameters/build |
...
1. Navigate to the directory of the sample.
   ...
   ```bash
   cd xxx/area_scan_3d_camera/Util/SetScanningParameters/
   ```
