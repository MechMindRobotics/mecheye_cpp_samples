...
2. Run Cmake and set the source and build paths:
   ...
   | Field                       | Path                                        |
   | :----                       | :----                                       |
   | Where is the source code    | xxx/SetPointCloudProcessingParameters       |
   | Where to build the binaries | xxx/SetPointCloudProcessingParameters/build |
...
1. Navigate to the directory of the sample.
   ...
   ```bash
   cd xxx/area_scan_3d_camera/Util/SetPointCloudProcessingParameters/
   ```
...
3. Run the sample.
   ...
   ```bash
   sudo ./SetPointCloudProcessingParameters
   ```
