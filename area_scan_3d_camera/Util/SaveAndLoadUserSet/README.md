...
With this sample, you can manage parameter groups, such as obtain the names of all parameter groups, add a parameter group, switch the parameter group, and save parameter settings to the parameter group.
...
2. Run Cmake and set the source and build paths:
   ...
   | Field                       | Path                         |
   | :----                       | :----                        |
   | Where is the source code    | xxx/SaveAndLoadUserSet       |
   | Where to build the binaries | xxx/SaveAndLoadUserSet/build |
...
1. Navigate to the directory of the sample.
   ...
   ```bash
   cd xxx/area_scan_3d_camera/Util/SaveAndLoadUserSet/
   ```
