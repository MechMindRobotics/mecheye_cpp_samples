...
2. Run Cmake and set the source and build paths:
   ...
   | Field                       | Path                              |
   | :----                       | :----                             |
   | Where is the source code    | xxx/ConnectAndCaptureImages       |
   | Where to build the binaries | xxx/ConnectAndCaptureImages/build |
...
1. Navigate to the directory of the sample.
   ...
   ```bash
   cd xxx/area_scan_3d_camera/Basic/ConnectAndCaptureImages/
   ```
