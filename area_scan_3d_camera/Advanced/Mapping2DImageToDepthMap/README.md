...
1. Navigate to the directory of the sample.
   ...
   ```bash
   cd xxx/area_scan_3d_camera/Basic/Mapping2DImageToDepthMap/
   ```
...
3. Run the sample.
   ...
   ```bash
   sudo ./Mapping2DImageToDepthMap
   ```

4. Enter the index of the camera to which you want to connect, and press the Enter key. The obtained files are saved to `/Mapping2DImageToDepthMap/build`.
