...
With this sample, you can warm up a Mech-Eye camera by periodically performing image acquisition over a specified duration to help the device reach stable operating conditions before use.
...
1. Navigate to the directory of the sample.
   ...
   ```bash
   cd xxx/area_scan_3d_camera/Advanced/WarmUp/
   ```
...
4. Enter the index of the camera to which you want to connect, and press the Enter key. The obtained files are saved to `/WarmUp/build`.
