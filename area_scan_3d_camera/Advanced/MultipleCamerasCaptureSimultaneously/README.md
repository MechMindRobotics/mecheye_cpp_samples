...
With this sample, you can obtain and save 2D images, depth maps and point clouds simultaneously from multiple cameras.
...
3. Run Cmake and set the source and build paths:
   ...
   | Field                       | Path                                           |
   | :----                       | :----                                          |
   | Where is the source code    | xxx/MultipleCamerasCaptureSimultaneously       |
   | Where to build the binaries | xxx/MultipleCamerasCaptureSimultaneously/build |
...
1. Navigate to the directory of the sample.
   ...
   ```bash
   cd xxx/area_scan_3d_camera/Advanced/MultipleCamerasCaptureSimultaneously/
   ```
...
3. Run the sample.
   ...
   ```bash
   sudo ./MultipleCamerasCaptureSimultaneously
   ```

4. Enter the index of the camera to which you want to connect, and press the Enter key. The obtained files are saved to `/MultipleCamerasCaptureSimultaneously/build`.
